...
% === Initialize Data ===
% m        - vector of spike amplitudes
% T        - total time duration in ms (1 second)
% x        - simulated position of the rat over time
% s        - times at which spikes occurred

figure; subplot(211); plot(1:T,x,s,x(s),'r.'); subplot(212); plot(s,m,'r.');
figure; plot(x(s),m,'r.')
